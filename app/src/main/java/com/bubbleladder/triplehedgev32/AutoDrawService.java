...
public class AutoDrawService extends Service {
    public static final String CHANNEL_ID="bubble_triple_hedge_v32_live";
    public static final int NOTI_ID=3321;
    ...
    private void createChannel(){
        if(Build.VERSION.SDK_INT>=26){
            NotificationChannel ch=new NotificationChannel(CHANNEL_ID,"삼치기 V3.2 자동추첨",NotificationManager.IMPORTANCE_LOW);
            ch.setDescription("다음 추첨 남은시간, V3.2 제외조합, 현재상황, 등급과 실전 성공률을 표시합니다.");
    ...
    private Notification buildNotification(){
        ...
        return b.setSmallIcon(android.R.drawable.ic_popup_sync)
                .setContentTitle("보글사다리3 삼치기 Hedge V3.2 · 백그라운드 ON")
                .setContentText(text)
